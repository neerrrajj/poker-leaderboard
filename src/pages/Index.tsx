...
import { Users, CalendarDays, DollarSign, Trophy, TrendingUp, TrendingDown } from 'lucide-react';
...
const Index = () => {
  ...
  const refreshData = async () => {
    ...
    try {
      ...
      setStats(newStats);
      setPlayers(newPlayers.slice(0, 3));
      ...
      <main className="flex-1 container max-w-screen-xl mx-auto px-4 py-6 pb-20 sm:pb-6">
        <div className="flex flex-col space-y-8">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tight">Poker Leaderboard</h1>
            <p className="text-muted-foreground">Track your poker sessions and see who's winning.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <StatCard 
              ...
              description={`${stats.activeSessions} active, ${stats.completedSessions} completed`}
            />
            <StatCard 
              title="Money Played" 
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <Button 
                  ...
                  size="sm"
                  onClick={() => navigate(
                    document.querySelector("[data-state='active']")?.getAttribute("value") === "players" 
                      ? "/players" 
                      : "/sessions"
                  )}
                >
              ...
              {players.length > 0 ? (
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center h-40">
                    ...
                    <p className="text-muted-foreground">No players yet. Add some to get started!</p>
                  </CardContent>
                </Card>
              )}
            </TabsContent>
              ...
              {sessions.length > 0 ? (
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center h-40">
                    ...
                    <p className="text-muted-foreground">No sessions yet. Add your first poker session!</p>
                  </CardContent>
                </Card>
              )}
            </TabsContent>
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">Recent performance across all sessions.</p>
            </div>
                ...
                <CardContent>
                  {players.length > 0 ? (
                    <div className="space-y-4">
                      ...
                      {players.filter(p => (p.totalCashOut - p.totalBuyIn) > 0).length === 0 && (
                  ...
                  {players.length > 0 ? (
                    <div className="space-y-4">
                      {players
                        .filter(p => (p.totalCashOut - p.totalBuyIn) < 0)
                        .sort((a, b) => 
                          (a.totalCashOut - a.totalBuyIn) - (b.totalCashOut - b.totalBuyIn)
                        )
                        .slice(0, 3)
                        .map((player, index) => {
